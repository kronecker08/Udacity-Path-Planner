...
void RoutePlanner::AddNeighbors(RouteModel::Node *current_node) {
    ...
    std::vector<RouteModel::Node *> neighbors_curr = current_node->neighbors;
    for(auto i : neighbors_curr){
    ...
    open_list.insert(open_list.end(), neighbors_curr.begin(), neighbors_curr.end());
}
